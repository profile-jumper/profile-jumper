    ...
    render() {
        ...
        return (
            <div {...idProperties} className={className} {...draggableOptions}>
                ...
                <ProfileTitle updateValue={(value, validity) => this.updateInput('profileTitle', value, validity)}
                              value={profileTitle.value} {...(this.props.updateHandler && {updateExisting: this.profileUpdateHandler})}/>
