    ...
    render() {
        ...
        return (
            <div className="ProfileTitle">
                <input type="text" name="profileTitle" value={profileTitleInput.value}
                       onChange={this.onChangedHandler} {...(this.props.updateExisting && {onBlur: this.props.updateExisting})} autoComplete="off"/>
            </div>
        )
    }
